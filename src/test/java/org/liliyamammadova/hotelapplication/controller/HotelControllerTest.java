...
public class HotelControllerTest {
    ...
    void givenValidId_whenRegister_thenReturnApartmentId() throws Exception {
        ...
        when(hotelService.register(price)).thenReturn(apartmentId);
        ...
        verify(hotelService).register(price);
    }
    ...
    void givenClientName_whenReserve_thenReturnSuccessReservation() throws Exception {
        ...
        when(hotelService.reserve(any(Client.class))).thenReturn(true);
        ...
        verify(hotelService).reserve(client);
    }
    ...
    void givenSortingParameters_whenGetApartments_thenReturnSortedApartments() throws Exception {
        ...
        when(hotelService.getPaginatedAndSortedApartments(0, 10, "price")).thenReturn(apartments);
        ...
        verify(hotelService).getPaginatedAndSortedApartments(0, 10, "price");
    }
}
